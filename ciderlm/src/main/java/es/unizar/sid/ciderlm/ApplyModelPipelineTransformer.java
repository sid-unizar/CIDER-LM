 ...
 */
public class ApplyModelPipelineTransformer extends MatcherYAAAJena {

    private static final Logger LOGGER = LoggerFactory.getLogger(ApplyModelPipelineTransformer.class);
    ...
    public ApplyModelPipelineTransformer(String gpu, String transformerModel, File transformersCache,
    ...
    public ApplyModelPipelineTransformer(MatcherYAAAJena recallMatcher, TransformersFilter transformersFilter) {
        this.recallMatcher = recallMatcher;
    ...
    public Alignment match(OntModel source, OntModel target, Alignment inputAlignment, Properties properties)
        ...
        if (isAutoThresholding) {
            ...
            potentiallyThresholded = confidenceFilter.filter(alignmentWithOneConfidence,
                    source, target);
        }
        ...
        return extractorMatcher.match(source, target, potentiallyThresholded,
                properties);
