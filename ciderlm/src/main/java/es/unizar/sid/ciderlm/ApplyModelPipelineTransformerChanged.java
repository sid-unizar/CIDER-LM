 ...
 */
public class ApplyModelPipelineTransformerChanged extends MatcherYAAAJena {

    private static final Logger LOGGER = LoggerFactory.getLogger(ApplyModelPipelineTransformerChanged.class);
    ...
    public ApplyModelPipelineTransformerChanged(String gpu, String transformerModel, File transformersCache,
    ...
    public ApplyModelPipelineTransformerChanged(MatcherYAAAJena recallMatcher, TransformersFilter transformersFilter) {
        this.recallMatcher = recallMatcher;
